    ...
    <v-app-bar height="fit-content" color="#02218f" absolute>
      <v-container fluid>
        <v-row>
          ...
          <v-col cols="4">
            <div class="parent d-flex justify-space-around aligns-center">
              <div class="available">
                <span>Available 24/7 at</span>
                <strong>01033939689</strong>
              </div>

              <div
                class="wishlists d-flex flex-column justify-center align-center"
              >
                <svg
          ...
          <v-col cols="4" class="d-flex justify-end">
            <div class="help d-flex align-center">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                class="icon svg-inline--fa fa-user-headset"
              >
                <path
                  fill="#ffb547"
            ...
            <div class="lang d-flex align-center" id="language-btn">
              ...
              <v-menu activator="#language-btn">
                <v-list v-model:selected="selectedLang">
                  ...
                  >
                    ...
                    >
                      <span class="menu-item-icon" v-html="lang.icon"></span>
...
export default {
  ...
  data: () => ({
    ...
    langs: [
      ...
      {
        icon: `<svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 512 512" class="icon" style="enable-background:new 0 0 512 512; width: 24px;" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve">
